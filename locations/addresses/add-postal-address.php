...
// Add Language
if(isset($_REQUEST['add-postal_address']))
	{
	...
	<p class="bg-success" style="text-align: center; font-weight: bold; padding: 5px;">
		The postal address has been added!
	</p>
	<center>
		...
		<button onclick="location.href='edit.php?location_id=<?php echo $location_id; ?>&location_name=<?php echo $location_name; ?>';" type="button" class="btn btn-default" style="marging-bottom: 5px;">Edit Postal Address <span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></button>
	</center>
	<?php
	curl_close($http);			
	}		
	...
	?>
	<form method="get" action="add-postal-address.php">
	...
	<div class="form-group">
	  ...
	  <button type="submit" class="btn btn-default" name="add-postal_address" value="1">Add This Postal Address</button>
	</form>
