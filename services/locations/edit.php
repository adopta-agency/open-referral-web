...
$api_url = $api_base_url . "services/" . $service_id . "/locations/" . $location_id . "/";
...
<form method="get" action="edit.php" name="SaveLocationForm">
  ...
  <button onclick="document.SaveLocationForm.submit();" type="submit" class="btn btn-default" name="edit-service" value="1">Save Any Changes</button>
</form>
